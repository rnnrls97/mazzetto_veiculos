...
import { files } from '@/data/dashboards/course'
  ...
  setup(props, { emit, expose }) {
    ...
    return () => {
      const input = h('input', {
        ...
        dataAllowReorder: pondOptions.allowReorder,
        files: pondOptions.files,
      })
      ...
      return h(
        'div',
        {
          class: [{'filepond-profile-wrap': props.profile}, props.size && `is-${props.size}`],
        },
        [wrapper],
      )
    }
