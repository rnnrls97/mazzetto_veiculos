...
// local vite plugin
import { VueroMarkdownDoc } from './resources/vite-plugin/vuero-doc'
import { PurgeComments } from './resources/vite-plugin/purge-comments'
...
export default defineConfig(({ isSsrBuild }) => ({
  ...
  plugins: [
    ...
    Imports({
      ...
      dirs: ['resources/js/composables', 'resources/js/stores', 'resources/js/utils'],
    }),
     ...
     * @see /resources/js/components/partials/documentation/DocumentationItem.vue
     * @see /resources/js/composable/useMarkdownToc.ts
     */
    VueroMarkdownDoc({
