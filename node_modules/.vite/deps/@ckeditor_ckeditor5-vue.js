  ...
  "node_modules/@ckeditor/ckeditor5-vue/dist/ckeditor.js"(exports, module) {
    !function(t, e) {
      ...
      return (() => {
        ...
        const $ = function(t3, n3, o2) {
          ...
          function j2() {
            ...
            if (i2 = arguments, r2 = this, c2 = t4, e3) {
              if (void 0 === l2) return v2(c2);
              if (p2) return clearTimeout(l2), l2 = setTimeout(y2, n3), h2(c2);
            }
        ...
        if (!t2.version || !t2.version.startsWith("3.")) throw new Error("The CKEditor plugin works only with Vue 3+. For more information, please refer to https://ckeditor.com/docs/ckeditor5/latest/builds/guides/integration/frameworks/vuejs-v3.html");
        const R = { install(t3) {
