...
export function newHsl(hVal, sVal, lVal, alphaVal) {
    const hsl = {
        h: hVal || 0,
        s: sVal || 0,
        l: lVal || 0,
...
export function newRgb(rVal, gVal, bVal, alphaVal) {
    const rgb = {
        r: rVal || 0,
        g: gVal || 0,
        b: bVal || 0,
...
export function getNameValFromColorDef(colorName, colorDef) {
...
export function strValFromColorDef(colorDef, colorName) {
