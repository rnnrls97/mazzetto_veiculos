...
var functions = {
  ...
  getMatchedRoutes(path) {
    ...
    const matched = (_b = (_a = import_devtools_kit.devtoolsRouter.value) == null ? void 0 : _a.resolve({
      path: path || "/"
    }).matched) != null ? _b : [];
    console.warn = c;
    return matched;
  ...
  unhighlight() {
    import_devtools_kit.devtools.ctx.hooks.callHook(import_devtools_kit.DevToolsContextHookKeys.COMPONENT_UNHIGHLIGHT);
  },
